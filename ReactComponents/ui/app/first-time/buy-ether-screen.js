...
import ShapeShiftForm from '../components/shapeshift-form'
import Identicon from '../components/identicon'
import {buyEth, showAccountDetail} from '../actions'
...
class BuyEtherScreen extends Component {
  ...
  OPTIONS = [
    {
      name: 'Direct Deposit',
      value: this.OPTION_VALUES.QR_CODE,
    },
    {
      name: 'Buy with Dollars',
      value: this.OPTION_VALUES.COINBASE,
    },
    {
      name: 'Buy with Cryptos',
      value: this.OPTION_VALUES.SHAPESHIFT,
    },
  ];
