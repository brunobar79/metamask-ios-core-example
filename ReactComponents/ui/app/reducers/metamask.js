...
const { getEnvironmentType } = require('../scripts/lib/util')
const { ENVIRONMENT_TYPE_POPUP } = require('../scripts/lib/enums')
const { OLD_UI_NETWORK_TYPE } = require('../scripts/controllers/network/enums')
